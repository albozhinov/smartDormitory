...
{
    [TestClass]
    public class GetAllPrivateUserSensorsAsync_Should
    {
        ...
        [TestMethod]
        public async Task ReturnAllPrivateUserSensorsFromCurrentUser_WhenArgumentIsCorrect()
        {
            // Arrange
            contextOptions = new DbContextOptionsBuilder<smartDormitoryDbContext>()
                .UseInMemoryDatabase(databaseName: "ReturnAllPrivateUserSensorsFromCurrentUser_WhenArgumentIsCorrect")
                .Options;
            ...
            using (var assertContext = new smartDormitoryDbContext(contextOptions))
            {
                ...
                // Act
                var allSensors = await userSensorServiceMock.GetAllPrivateUserSensorsAsync(userId);
