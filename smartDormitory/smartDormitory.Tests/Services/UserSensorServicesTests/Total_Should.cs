...
namespace smartDormitory.Tests.Services.UserSensorServicesTests
{
    ...
    public class Total_Should
    {
        ...
        [TestMethod]
        public void ReturnCountOfAllNotDeletedUserSensors()
        {
            // Arrange
            contextOptions = new DbContextOptionsBuilder<smartDormitoryDbContext>()
                .UseInMemoryDatabase(databaseName: "ReturnCountOfAllNotDeletedUserSensors")
                .Options;
            ...
            using (var assertContext = new smartDormitoryDbContext(contextOptions))
            {
                ...
                // Act
                var totalSensorsCountMock = userSensorServiceMock.Total();

                // Assert
                Assert.IsTrue(totalSensorsCountMock == 2);
            }
        }
    }
}
